# Generated by Django 4.2.13 on 2024-06-02 19:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('waivers', models.ManyToManyField(blank=True, help_text='Required waivers for registration.', to='RelayEntry.document')),
            ],
        ),
        migrations.CreateModel(
            name='Leg',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='photo_packages', to='RelayEntry.event')),
            ],
        ),
        migrations.CreateModel(
            name='Race',
            fields=[
                ...
                ('same_distance', models.BooleanField(blank=True, default=False, help_text='Whether each leg of the team relay race is the same distance.', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('leg', models.OneToOneField(blank=True, help_text='The leg the team member is running (if applicable).', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teammember', to='RelayEntry.leg')),
        ...
        migrations.AddField(
            model_name='leg',
            name='race',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='legs', to='RelayEntry.race'),
        ),
        migrations.AddField(
