# Generated by Django 4.2.14 on 2024-07-10 23:32
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='registration',
            name='photo_package',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='RelayEntry.photopackage'),
        ),
        migrations.AddField(
            model_name='registration',
            name='race',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='registrations', to='RelayEntry.race'),
        ),
        migrations.AddField(
