...
urlpatterns = [
    ...
    path('api/dashboard/events/<int:event_id>/races/', views.UserRacesListAPIView.as_view(), name='user-races'),
    path('api/dashboard/races/update/<int:id>/', views.RaceUpdateView.as_view(), name='race-update'),
    path('api/dashboard/races/<int:id>/', views.UserRaceAPIView.as_view(), name='user-race'),
