            ...
            <v-card-text>
              <v-row v-if="teamData">
                ...
                <v-col cols="12" md="6">
                  ...
                  <p class="mb-2 mt-1 wrap-break-word">Email relayentry@gmail.com from your registration email to make team member changes. Include your confirmation number.</p>
                  <v-row>
